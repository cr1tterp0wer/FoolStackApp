<template>
  <div>
    ...
    <section
      id='page-top'
      class='section-style'
      data-background-image='images/background/page-top.jpg'
    >
    ...
    <section
      id='about'
      class='section-style'
      data-background-image='images/background/about-us.jpg'
    >
      <div class='pattern height-resize'>
        <div class='container'>
          <h3 class='section-name'>
    ...
    <section
      id='subscribe'
      class='section-style'
      data-background-image='images/background/newsletter.jpg'
    >
      <div class='pattern height-resize'>
        <div class='container'>
          <h3 class='section-name'>
          ...
          <form class='news-letter' method='post'>
            ...
            <div class='subscribe-hide'>
              ...
              <span id='subscribe-loading' class='btn'>
          ...
          <div class='social-btn-container'>
            <span class='social-btn-box'>
              <a href='#' class='facebook-btn'> <i class='fa fa-facebook'></i></a> </span
            ><!-- /.social-btn-box -->

            <span class='social-btn-box'>
              <a href='#' class='twitter-btn'><i class='fa fa-twitter'></i></a> </span
            ><!-- /.social-btn-box -->

            <span class='social-btn-box'>
              <a href='#' class='linkedin-btn'><i class='fa fa-linkedin'></i></a> </span
            ><!-- /.social-btn-box -->

            <span class='social-btn-box'>
              <a href='#' class='google-plus-btn'><i class='fa fa-google-plus'></i></a> </span
            ><!-- /.social-btn-box -->

            <span class='social-btn-box'>
              <a href='#' class='youtube-btn'><i class='fa fa-youtube'></i></a> </span
            ><!-- /.social-btn-box -->
          </div>
          <!-- /.social-btn-container -->
          ...
          <form id='contact-form' action='email.php' method='post' class='clearfix'>
            <div class='contact-box-hide'>
              ...
              <div class='col-sm-2'>
                <button
                  id='contact-submit'
                  class='btn custom-btn col-xs-12'
                  type='submit'
                  name='submit'
                >
